...
def activate(_win, _box):
    ...
    register.button.connect("button_press_event", register_user, email_entry, username_entry, password_entry)
...
def register_user(button, event, email_entry, username_entry, password_entry):
